  ...
  Future<void> verifyOtp() async {
    ...
    try {
      ...
      try {
        ...
        debugPrint("STUDENT LOGIN GET CURRENT USER ERROR => $e");
      }

      if (!mounted) return;

      final studentProfile = currentUser?["studentProfile"];
      ...
      /// CHECK DOCUMENTS
      final documents =
          (studentProfile["documents"] as List?)?.cast<dynamic>() ?? [];

      if (documents.length < 5) {
        Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(
            builder: (_) => const StudentDocumentUploadScreen(),
          ),
          (route) => false,
        );
        return;
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Image.asset("assets/images/student_role.png", height: 120),
