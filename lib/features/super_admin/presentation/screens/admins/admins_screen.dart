...
class AdminsScreen extends StatefulWidget {
  ...
  const AdminsScreen({super.key, required this.onNavigate});
...
class _AdminsScreenState extends State<AdminsScreen> {
  ...
  Future<void> fetchAdmins() async {
    try {
      ...
      final response = await SuperAdminService.getAdmins();
  ...
  void applySearch() {
    filteredAdmins = admins.where((admin) {
      ...
      final district = (admin["district"] ?? "").toString().toLowerCase();
  ...
  List get paginatedAdmins {
    ...
    if (end > filteredAdmins.length) {
      end = filteredAdmins.length;
    }

    return filteredAdmins.sublist(start, end);
  }
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: "Search admin, district, phone",
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (_, index) {
                          final admin = paginatedAdmins[index];
                            ...
                            child: Column(
                              children: [
                                ...
                                buildInfoRow(
                                  icon: Icons.school,
                                  title: "Students",
                                  value: admin["studentCount"].toString(),
                                ),
                                ...
                                buildInfoRow(
                                  icon: Icons.groups,
                                  title: "Mentors",
                                  value: admin["mentorCount"].toString(),
                                ),
