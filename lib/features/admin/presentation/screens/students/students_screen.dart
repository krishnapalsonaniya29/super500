...
class _StudentsScreenState extends State<StudentsScreen> {
  ...
  /// DEACTIVATE STUDENT
  /// =====================================
  void showDeactivateDialog(String studentId, String studentName) {
    showDialog(
      context: context,
      builder: (_) => AlertDialog(
  ...
  Future<void> rejectStudent({
    ...
    try {
      ...
      await AdminService.rejectStudent(id: id, reason: reason);
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              await rejectStudent(id: id, reason: controller.text);
            },
                          ...
                          Wrap(
                            ...
                            children: [
                              actionButton(
                                ...
                                color: const Color.fromARGB(255, 1, 230, 134),
                              ...
                              actionButton(
                                ...
                                onTap: () async {
                                  await Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (_) =>
                                          AssignMentorScreen(student: student),
                                    ),
                                  );
                          ...
                          if (status == "PENDING")
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton.icon(
                                ...
                                label: const Text("Reactivate Student"),
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: Colors.green,
                                ),
                              ),
