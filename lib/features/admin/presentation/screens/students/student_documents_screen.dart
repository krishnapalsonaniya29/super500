...
class _StudentDocumentsScreenState extends State<StudentDocumentsScreen> {
  ...
  void updateDocumentStatus(String id, bool verified) {
  ...
  Color getStatusColor(bool verified) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("${user["fullName"]} Documents"),
                        ...
                        child: Row(
                          children: [
                            const Icon(
                              Icons.link,
                              size: 18,
                              color: Color.fromARGB(255, 30, 95, 50),
                            ),
