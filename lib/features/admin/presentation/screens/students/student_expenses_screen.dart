...
class StudentExpensesScreen extends StatefulWidget {
  ...
  const StudentExpensesScreen({super.key, required this.student});

  @override
  State<StudentExpensesScreen> createState() => _StudentExpensesScreenState();
}

class _StudentExpensesScreenState extends State<StudentExpensesScreen> {
  ...
  Future<void> approveExpense(String expenseId) async {
    try {
      ...
      await AdminService.approveExpense(id: expenseId);
      ...
      setState(() {
        final expenses = widget.student["expenses"];
  ...
  Future<void> rejectExpense(String expenseId) async {
    ...
    try {
      ...
      await AdminService.rejectExpense(id: expenseId, remarks: reason);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("${user["fullName"]} Expenses"),
        backgroundColor: AppColors.primary,
        foregroundColor: Colors.white,
      ),

      body: expenses.isEmpty
          ? const Center(child: Text("No expenses submitted"))
          : ListView.builder(
